...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/npulagam/iris_flowers_classification/master/App1/prepared_data.csv')
...
######################
# User defined values
title = 'IRIS Flowers TYpe Classification App'
encoder_location = ''
target_encoder_location = 'https://github.com/npulagam/iris_flowers_classification/blob/master/App1/target_encoder.pkl?raw=true'
